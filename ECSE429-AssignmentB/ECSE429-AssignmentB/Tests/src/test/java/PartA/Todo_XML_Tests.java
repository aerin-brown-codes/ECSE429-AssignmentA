...
public class Todo_XML_Tests {
    ...
    public void getAllTodos() throws MalformedURLException, IOException {
        ...
        String expectedXml = "<todos><todo><doneStatus>false</doneStatus><description/><tasksof><id>1</id></tasksof><id>2</id><title>file paperwork</title></todo><todo><doneStatus>false</doneStatus><description/><tasksof><id>1</id></tasksof><id>1</id><categories><id>1</id></categories><title>scan paperwork</title></todo></todos>";

        // assert
        assertEquals(200, status);

        Diff xmlDiff = DiffBuilder.compare(expectedXml)
            .withTest(content.toString())
            .ignoreWhitespace()
            .checkForSimilar()
            .build();

        assertFalse(xmlDiff.hasDifferences(), "XML response does not match expected structure: " + xmlDiff.toString());
