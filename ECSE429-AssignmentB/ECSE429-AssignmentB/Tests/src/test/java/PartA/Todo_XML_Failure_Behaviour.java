...
public class Todo_XML_Failure_Behaviour {
    ...
    public void getTodoFailure() throws MalformedURLException, IOException {
        ...
        assertEquals("<errorMessages><errorMessage>Could not find an instance with todos/25</errorMessage></errorMessages>", result);
    }
    ...
    public void testCreateTodo() throws MalformedURLException, IOException {
        ...
        assertEquals("<errorMessages><errorMessage>title : field is mandatory</errorMessage></errorMessages>", result);
    }
    ...
    public void testDeleteTodo() throws MalformedURLException, IOException {
        ...
        // assert
        assertEquals(404, status);
        assertEquals("<errorMessages><errorMessage>Could not find any instances with todos/25</errorMessage></errorMessages>", result);
    }
    ...
    public void testDeleteTodoProjectRelationship() throws MalformedURLException, IOException {
        ...
        // assert
        assertEquals(404, status);
        assertEquals("<errorMessages><errorMessage>Could not find any instances with todos/25/tasksof/25</errorMessage></errorMessages>", result);
    }
    ...
    public void testDeleteTodoCategoryRelationship() throws MalformedURLException, IOException {
        ...
        // assert
        assertEquals(404, status);
        assertEquals("<errorMessages><errorMessage>Could not find any instances with todos/25/categories/25</errorMessage></errorMessages>", result);
    }
}
