...
public class ViewTodosTests {
    ...
    @Given("the database contains the initial default objects")
    ...
    @When("the user attempts to view the todo with id {int} via JSON payload")
    public void viewJSONTodos(Integer id) throws IOException {
    ...
    @Then("the message is Could not find any instances with todos/25")
