...
public class ViewProjectTests {
    ...
    public void setupProject() throws IOException, InterruptedException {
    ...
    @Given("the database contains the given objects")
    ...
    @Then("the status code {int} is layed out")
    ...
    private String readResponse(HttpURLConnection con) throws IOException {
        ...
        if (con.getResponseCode() >= 400) {
            in = new BufferedReader(new InputStreamReader(con.getErrorStream())); // Use error stream for errors
        } else {
