...
public class Todo_JSON_Tests {
    ...
    @Test
    public void getAllTodos() throws MalformedURLException, IOException, JSONException {
        // arrange
    ...
    @Test
    public void getTodoProjects() throws MalformedURLException, IOException, JSONException {
        // arrange
        ...
        // assert
        assertEquals(200, status);
        JSONAssert.assertEquals("{\"projects\":[{\"id\":\"1\",\"title\":\"Office Work\",\"completed\":\"false\",\"active\":\"false\",\"description\":\"\",\"tasks\":[{\"id\":\"1\"},{\"id\":\"2\"}]}]}", result, JSONCompareMode.NON_EXTENSIBLE);
    }
    ...
    public void testUpdateTodoPost() throws MalformedURLException, IOException {
        ...
        // assert
        assertEquals(200, status);
        assertEquals("{\"id\":\"1\",\"title\":\"test\",\"doneStatus\":\"true\",\"description\":\"test\",\"tasksof\":[{\"id\":\"1\"}],\"categories\":[{\"id\":\"1\"}]}", result);
    }
